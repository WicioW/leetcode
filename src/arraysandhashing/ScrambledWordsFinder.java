...
public class ScrambledWordsFinder {
    public static void main(String[] argv) {
        ...
        ScrambledWordsFinder solution = new ScrambledWordsFinder();
        System.out.println(solution.allCharsContained(words, note1));
        System.out.println(solution.allCharsContained(words, note2));
        System.out.println(solution.allCharsContained(words, note3));
        System.out.println(solution.allCharsContained(words, note4));
        System.out.println(solution.allCharsContained(words, note5));
        System.out.println(solution.allCharsContained(words, note6));
        System.out.println(solution.allCharsContained(words, note7));
    }


    private String allCharsContained(String[] words, String note) {
        Map<Character, Integer> counterMap;
        for (String word : words) {
            ...
            boolean allCounterZero = counterMap.values().stream()
                    .allMatch(v -> v == 0);
